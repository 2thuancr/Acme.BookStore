...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p e172460d-e65c-4be3-854f-880c520440d7
```

> `e172460d-e65c-4be3-854f-880c520440d7` is the password of the certificate, you can change it to any password you want.
